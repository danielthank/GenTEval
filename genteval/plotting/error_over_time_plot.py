...
def extract_error_data_by_filter(report_data, experiments, filter_level, weighted=False):
    """
...
def plot_error_scatter(data_points, metric, filter_level, output_dir):
    ...
    filename = f"error_over_time_{filter_suffix[filter_level]}_{metric_short}.png"
...
def generate_all_error_plots(report_path, output_dir="./plots", weighted=False):
    """
    ...
    for filter_level in [0, 1, 2]:
        ...
        for metric in ["mape_fidelity", "cosine_fidelity"]:
            plot_error_scatter(data_points, metric, filter_level, output_dir)
